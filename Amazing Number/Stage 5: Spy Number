...
public class Main {
    ...
    public static void showProperties(long number, boolean checkInput) {
        ...
        if (checkInput) {
            ...
            System.out.println(number + " is " + isBuzz + isDuck + isPalindromic + isGapful + isSpy + isEven);
        } else {
    ...
    public static boolean findProperty(String property) {
        String[] listProperties = {"even", "odd", "buzz", "duck", "palindromic", "gapful", "spy"};
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (numberString.contains(" ")) {
                ...
                } else if (!findProperty(thirdNum) && !thirdNum.isBlank()) {
